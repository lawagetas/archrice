source ~/.local/share/archrice/default/bash/functions
...
web2app "Grok" https://grok.com/ https://registry.npmmirror.com/@lobehub/icons-static-png/1.51.0/files/dark/grok.png

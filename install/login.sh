...
# cat <<EOF | sudo tee /etc/systemd/system/archrice-seamless-login.service
# [Unit]
# Description=Archrice Seamless Auto-Login
# Documentation=https://github.com/basecamp/archrice
...
# sudo systemctl enable archrice-seamless-login.service
